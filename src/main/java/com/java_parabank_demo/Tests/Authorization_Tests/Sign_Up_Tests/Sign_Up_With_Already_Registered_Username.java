...
public class Sign_Up_With_Already_Registered_Username extends LoadTheDriver {
    ...
    public void SignUpToTheWebsiteAgain() {
        ...
        new WebDriverWait(getDriver(), timeout).until(ExpectedConditions.presenceOfElementLocated(sign_up_form.usernameTakenError));
        String usernameTakenError = getDriver().findElement(sign_up_form.usernameTakenError).getText();
