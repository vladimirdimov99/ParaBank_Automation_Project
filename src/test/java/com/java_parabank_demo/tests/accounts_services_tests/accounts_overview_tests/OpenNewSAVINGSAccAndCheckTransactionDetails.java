...
public class OpenNewSAVINGSAccAndCheckTransactionDetails extends TestBase {
    ...
    public void openNewSavingsAccountAndCheckAccDetails() {
        ...
        new WebDriverWait(driver, timeout).until(ExpectedConditions.elementToBeSelected(openNewAccountForm.selectSavingsAccount));
